...
export default function DatasetDetailPage() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      alert(
        "Purchase successful! Download link has been sent to your wallet address.",
      );
    } catch (error) {
            ...
            <div className="rounded-lg border border-destructive/50 bg-destructive/10 p-8 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {error
                  ...
                  : "This dataset may have been removed or is no longer available"}
              </p>
              <div className="mt-4 flex gap-3 justify-center">
                <Button onClick={fetchDataset} variant="outline">
                  Try Again
                </Button>
                <Button asChild>
                  <Link href="/marketplace">Browse All Datasets</Link>
                </Button>
              </div>
            </div>
          </div>
                ...
                <TabsContent value="samples" className="space-y-4">
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      dataset.sample_videos.length > 0 ? (
                        <>
                          {dataset.sample_videos.map((video) => (
                            <div
                              key={video.id}
                          ...
                          <p className="pt-2 text-xs text-muted-foreground">
                            Purchase the full dataset to access all{" "}
                            {dataset.video_count.toLocaleString()} videos
                          </p>
                        </>
                      ) : (
                        <p className="text-sm text-muted-foreground">
                          No sample videos available for this dataset.
                        </p>
                      )}
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {dataset.video_count.toLocaleString()}
                        </span>
                      </div>
                      <Separator />
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {dataset.contributors.toLocaleString()}
                        </span>
                      </div>
                      <Separator />
                      <div className="flex justify-between text-sm">
                      ...
                      {dataset.metadata && (
                        <>
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {dataset.metadata.total_duration}
                            </span>
                          </div>
                          <Separator />
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {dataset.metadata.avg_video_duration}
                            </span>
                          </div>
                          <Separator />
                          <div className="flex justify-between text-sm">
