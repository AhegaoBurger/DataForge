  ...
  return (
    <Card className="flex flex-col border-border/50 bg-card/50 backdrop-blur transition-all hover:border-primary/50">
      <CardHeader>
        ...
        <h3 className="text-balance text-xl font-semibold leading-tight">{bounty.title}</h3>
        <p className="mt-2 text-pretty text-sm text-muted-foreground leading-relaxed">{bounty.description}</p>
      </CardHeader>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium">
              {bounty.videosSubmitted} / {bounty.videosNeeded}
            </span>
          </div>
